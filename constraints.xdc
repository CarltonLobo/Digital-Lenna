...
###Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { kern_blur }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { kern_inv }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { kern_sharp }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { kern_gaus }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { kern_sobel }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { kern_emboss }]; #IO_L7N_T1_D10_14 Sch=sw[5]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { kern_prewitt }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { kern_lap }]; #IO_L5N_T0_D07_14 Sch=sw[7]
##set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { cin }]; #IO_L24N_T3_34 Sch=sw[8]
##set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { mode }]; #IO_25_34 Sch=sw[9]
##set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { enable }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
...
##set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { out2[1] }]; #IO_L24P_T3_RS1_15 Sch=led[1]
##set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { out2[2] }]; #IO_L17N_T2_A25_15 Sch=led[2]
##set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { out2[3] }]; #IO_L8P_T1_D11_14 Sch=led[3]
...
##set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { inactive[0] }]; #IO_L8N_T1_D12_14 Sch=an[4]
##set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { inactive[1] }]; #IO_L14P_T2_SRCC_14 Sch=an[5]
##set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { inactive[2] }]; #IO_L23P_T3_35 Sch=an[6]
##set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { inactive[3] }]; #IO_L23N_T3_A02_D18_14 Sch=an[7]
...
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { down }]; #IO_L12P_T1_MRCC_14 Sch=btnl
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { left }]; #IO_L10N_T1_D15_14 Sch=btnr
#set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { right }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
